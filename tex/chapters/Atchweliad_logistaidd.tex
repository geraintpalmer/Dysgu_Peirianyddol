...
Gwelwn yn y graff nesaf fod y plot yn dangos ein data yn wych. % Na. Nawn ni siarad am y graff hyn.
...
Mae hyn hyd yn oed fwy cywir pan fyddem yn cymharu atchweliad logistaidd i atchweliad llinol. % Pa problemau arall sydd da atchweliad llinol? gallwn cael P(x) < 0 neu P(x) > 1; nid yw atchweliad logistaidd yn gadael hwn i ddigwydd.
...
Mae'r c\^{o}d uchod yn rhannu'r setiau gan ddefnyddio eu cofnod o fynediad (rhif y rhes) yn y data ac yno mae'r c\^{o}d isod yn rhannu'r fectorau i mewn i setiau arwahan.  % "cofnod o fynediad" yw indecs ie? Meddwl fod indecs yn well (heblaw for hwn yn peth penodol ar gyfer R)
